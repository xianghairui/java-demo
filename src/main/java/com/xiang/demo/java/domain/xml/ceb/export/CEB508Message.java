 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.chinaport.gov.cn/ceb}ArrivalReturn" maxOccurs="100"/&gt;
 *       &lt;/sequence&gt;
...
public class CEB508Message {
    ...
    protected List<ArrivalReturn> arrivalReturn;
     ...
     * 
     */
    public List<ArrivalReturn> getArrivalReturn() {
        if (arrivalReturn == null) {
            arrivalReturn = new ArrayList<ArrivalReturn>();
        }
