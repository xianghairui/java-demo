 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.chinaport.gov.cn/ceb}SummaryApply" maxOccurs="100"/&gt;
...
public class CEB701Message {
    ...
    protected List<SummaryApply> summaryApply;
     ...
     * 
     */
    public List<SummaryApply> getSummaryApply() {
        if (summaryApply == null) {
            summaryApply = new ArrayList<SummaryApply>();
        }
