 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.chinaport.gov.cn/ceb}InvtRefundReturn" maxOccurs="100"/&gt;
 *       &lt;/sequence&gt;
...
public class CEB626Message {
    ...
    protected List<InvtRefundReturn> invtRefundReturn;
     ...
     * {@link InvtRefundReturn }
     * 
     * 
     */
    public List<InvtRefundReturn> getInvtRefundReturn() {
        if (invtRefundReturn == null) {
            invtRefundReturn = new ArrayList<InvtRefundReturn>();
        }
