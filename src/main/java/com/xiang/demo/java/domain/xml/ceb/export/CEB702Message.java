 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.chinaport.gov.cn/ceb}SummaryReturn" maxOccurs="100"/&gt;
 *       &lt;/sequence&gt;
...
public class CEB702Message {
    ...
    protected List<SummaryReturn> summaryReturn;
     ...
     * 
     */
    public List<SummaryReturn> getSummaryReturn() {
        if (summaryReturn == null) {
            summaryReturn = new ArrayList<SummaryReturn>();
        }
