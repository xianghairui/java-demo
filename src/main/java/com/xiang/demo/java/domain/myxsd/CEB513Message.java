 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.chinaport.gov.cn/ceb}LogisticsStatus" maxOccurs="100"/&gt;
...
public class CEB513Message {
    ...
    protected List<LogisticsStatus> logisticsStatus;
    ...
    public List<LogisticsStatus> getLogisticsStatus() {
        if (logisticsStatus == null) {
            logisticsStatus = new ArrayList<LogisticsStatus>();
        }
