 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.chinaport.gov.cn/ceb}SummaryResult" maxOccurs="100"/&gt;
 *       &lt;/sequence&gt;
...
public class CEB792Message {
    ...
    protected List<SummaryResult> summaryResult;
     ...
     * 
     */
    public List<SummaryResult> getSummaryResult() {
        if (summaryResult == null) {
            summaryResult = new ArrayList<SummaryResult>();
        }
