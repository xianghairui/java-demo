 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.chinaport.gov.cn/ceb}ReceiptsReturn" maxOccurs="100"/&gt;
 *       &lt;/sequence&gt;
...
public class CEB404Message {
    ...
    protected List<ReceiptsReturn> receiptsReturn;
     ...
     * 
     */
    public List<ReceiptsReturn> getReceiptsReturn() {
        if (receiptsReturn == null) {
            receiptsReturn = new ArrayList<ReceiptsReturn>();
        }
